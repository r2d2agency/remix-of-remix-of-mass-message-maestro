...
export function KanbanBoard({ stages, dealsByStage, onDealClick, onStatusChange, newWinDealId, selectedIds, selectionMode, onToggleSelect, onSelectColumn }: KanbanBoardProps) {
